...
/**
 * Classe dell'istruzione RTI con tutti i possibili indirizzamenti
 * @author Roberto Palmieri, Giulio Vennari
 */
public class RTI extends Istruzione {
    /**
     ...
     */
    protected RTI(LinkedList l, char[] c) throws ParseException {
        super(l.get(0), null, null);
        assegnaByte(l, c);
        comment.add("Instruction RTI: POPSR; POP PC");
    }
