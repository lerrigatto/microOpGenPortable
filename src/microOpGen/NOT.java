...
/**
 * Classe dell'istruzione NOT con tutti i possibili indirizzamenti
 * @author Roberto Palmieri, Giulio Vennari
 */
public class NOT extends Istruzione {
    /**
     ...
     */
    protected NOT(LinkedList l, char[] c) throws ParseException {
        super(l.get(0),
        	((l.size() == 4) ? l.get(3) : l.get(2)),
        	((l.size() == 4) ? l.get(2) : l.get(1)));
        assegnaByte(l, c);
        comment.add("Instruction NOT: compl1(SORG) -> Ri");
    }
