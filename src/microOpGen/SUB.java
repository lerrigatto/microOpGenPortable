...
/**
 * Classe dell'istruzione SUB con tutti i possibili indirizzamenti
 * @author Roberto Palmieri, Giulio Vennari
 */
public class SUB extends Istruzione {
    /**
     ...
     */
    protected SUB(LinkedList l, char[] c) throws ParseException {
        super(l.get(0),
        	((l.size() == 4) ? l.get(3) : l.get(2)),
        	((l.size() == 4) ? l.get(2) : l.get(1)));
        assegnaByte(l, c);
        comment.add("Instruction SUB: Ri - SORG -> Ri");
    }
