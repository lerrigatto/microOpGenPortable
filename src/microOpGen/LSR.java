...
/**
 * Classe dell'istruzione LSR con tutti i possibili indirizzamenti
 * @author Roberto Palmieri, Giulio Vennari
 */
public class LSR extends Istruzione {
    /**
     ...
     */
    protected LSR(LinkedList l, char[] c) throws ParseException {
        super(l.get(0), l.get(2), l.get(1));
        assegnaByte(l, c);
        comment.add("Instruction LSR: logical shift dx of K position Ry -> Ry\nRy[K-1] -> Carry; Write 0 in most significant K bits");
    }
	...
	protected LinkedList getMO(){
		mop.add("RY -> TEMP2");
		mop.add("SHIFTER_OUT[LOGIC DX] -> RY");
		return mop;
	}
}