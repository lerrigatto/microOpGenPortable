...
/**
 * Classe dell'istruzione SBB con tutti i possibili indirizzamenti
 * @author Roberto Palmieri, Giulio Vennari
 */
public class SBB extends Istruzione {
    /**
     ...
     */
    protected SBB(LinkedList l, char[] c) throws ParseException {
        super(l.get(0),
        	((l.size() == 4) ? l.get(3) : l.get(2)),
        	((l.size() == 4) ? l.get(2) : l.get(1)));
        assegnaByte(l, c);
        comment.add("Instruction SBB: Ri - SORG - Carry -> Ri");
    }
	...
	protected LinkedList getMO(){
		...
		mop.add("RY -> TEMP2");
		mop.add("ALU_OUT[SUB_with_Carry] -> RY");
