...
/**
 * Classe dell'istruzione RCL con tutti i possibili indirizzamenti
 * @author Roberto Palmieri, Giulio Vennari
 */
public class RCL extends Istruzione {
    /**
     ...
     */
    protected RCL(LinkedList l, char[] c) throws ParseException {
        super(l.get(0), l.get(2), l.get(1));
        assegnaByte(l, c);
        comment.add("Instruction RCL: rotate sx of K position Ry -> Ry\nRy[32] -> Carry -> Ry[0]");
    }
