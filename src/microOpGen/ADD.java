...
/**
 * Classe dell'istruzione ADD con tutti i possibili indirizzamenti
...
public class ADD extends Istruzione {
     ...
     */
    protected ADD(LinkedList l, char[] c) throws ParseException {
        super(l.get(0),
        	((l.size() == 4) ? l.get(3) : l.get(2)),
        	((l.size() == 4) ? l.get(2) : l.get(1)));
        assegnaByte(l, c);
        comment.add("Instruction ADD: SORG + Ri + Carry-> Ri");
    }
