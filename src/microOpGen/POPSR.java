...
/**
 * Classe dell'istruzione POPSR con tutti i possibili indirizzamenti
 * @author Roberto Palmieri, Giulio Vennari
 */
public class POPSR extends Istruzione {
    /**
     ...
     */
    protected POPSR(LinkedList l, char[] c) throws ParseException {
        super(l.get(0), null, null);
        assegnaByte(l, c);
        comment.add("Instruction POPSR: MOVTOSR (R7)+");
    }
