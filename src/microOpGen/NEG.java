...
/**
 * Classe dell'istruzione NEG con tutti i possibili indirizzamenti
 * @author Roberto Palmieri, Giulio Vennari
 */
public class NEG extends Istruzione {
    /**
     ...
     */
    protected NEG(LinkedList l, char[] c) throws ParseException {
        super(l.get(0),
        	((l.size() == 4) ? l.get(3) : l.get(2)),
        	((l.size() == 4) ? l.get(2) : l.get(1)));
        assegnaByte(l, c);
        comment.add("Instruction NEG: 0 - SORG -> Ri");
    }
