...
/**
 * Classe dell'istruzione CMP con tutti i possibili indirizzamenti
...
public class CMP extends Istruzione {
     ...
     */
    protected CMP(LinkedList l, char[] c) throws ParseException {
        super(l.get(0),
        	((l.size() == 4) ? l.get(3) : l.get(2)),
        	((l.size() == 4) ? l.get(2) : l.get(1)));
        assegnaByte(l, c);
        comment.add("Instruction CMP: Ri - SORG");
    }
