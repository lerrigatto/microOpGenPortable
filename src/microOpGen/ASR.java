...
/**
 * Classe dell'istruzione ASR con tutti i possibili indirizzamenti
 * @author Roberto Palmieri, Giulio Vennari
 */
public class ASR extends Istruzione {
    /**
     ...
     */
    protected ASR(LinkedList l, char[] c) throws ParseException {
        super(l.get(0), l.get(2), l.get(1));
        assegnaByte(l, c);
        comment.add("Instruction ASR: arithmetic shift dx of K position Ry -> Ry\nRy[K-1] -> Carry");
    }
	...
	protected LinkedList getMO(){
		mop.add("RY -> TEMP2");
		mop.add("SHIFTER_OUT[ARITMETIC DX] -> RY");
		return mop;
	}
}