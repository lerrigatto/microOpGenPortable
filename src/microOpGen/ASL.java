...
/**
 * Classe dell'istruzione ASL con tutti i possibili indirizzamenti
 * @author Roberto Palmieri, Giulio Vennari
 */
public class ASL extends Istruzione {
    /**
     ...
     */
    protected ASL(LinkedList l, char[] c) throws ParseException {
        super(l.get(0), l.get(2), l.get(1));
        assegnaByte(l, c);
        comment.add("Instruction ASL: arithmetic shift sx of K position Ry -> Ry\nRy[32-K] -> Carry");
    }
	...
	protected LinkedList getMO(){
		mop.add("RY -> TEMP2");
		mop.add("SHIFTER_OUT[ARITMETIC SX] -> RY");
		return mop;
	}
}