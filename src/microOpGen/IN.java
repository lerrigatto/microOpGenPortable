...
/**
 * Classe dell'istruzione IN con tutti i possibili indirizzamenti
 * @author Roberto Palmieri, Giulio Vennari
 */
public class IN extends Istruzione {
    /**
     ...
     */
    protected IN(LinkedList l, char[] c) throws ParseException {
        super(l.get(0), ((l.size() == 4) ? l.get(3) : l.get(2)), l.get(1));
        assegnaByte(l, c);
        comment.add("Instruction IN: Buffer of DEVICE -> DEST");
    }
